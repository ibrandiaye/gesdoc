...
@section('title', '| Enregister fichier')
    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('fichier.index') }}" >Ajouter un fichier</a></li>

                        </ol>
                    </div>
                    Gestion Vote Document
             ...
             <div class="card">
                        <div class="card-header ">
                            <div class="text-center">
                                FORMULAIRE D'ENREGISTREMENT D'UN fichier
                            </div>
